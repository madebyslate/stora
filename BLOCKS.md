...
| `LogoWall` | 🟢 done | `home`, `about-us` | 352 B inline (wspólny obserwator) | Logotypy tworzą bezszwowo zapętlone marquee ograniczone do wspólnego `inner`, bez lokalnego JS; drugi zestaw jest ukryty semantycznie, a `prefers-reduced-motion` przywraca pełną statyczną siatkę. Testy bloku: 14/14 (desktop + mobile), snapshoty bez regresji. Lighthouse Home: 100/96/100/100, About Us: 100/96/100/100. `LogoWall.spec.md`. |
